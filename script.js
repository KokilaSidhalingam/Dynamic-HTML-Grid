...
// Creating cards by itrating into array of objec
...
productList.forEach(list => {
    ...
    h5Element.innerText = list.brand;
    // Product price
    let h4Element = document.createElement("h4");
    h4Element.innerText = list.price;

    // Appending parent and child
    mainDiv.append(imageDiv,detailDiv);
    imageDiv.append(mainImage);
    detailDiv.append(h3Element, h5Element, h4Element);

    //  Appending the card to the sections
    if(list.isAccessory){
